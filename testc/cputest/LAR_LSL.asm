...
TEST_LAR_LSL			PROC
						...
						MOV		WORD PTR GS:[TEST_SEG],2345H
						MOV		BYTE PTR GS:[TEST_SEG+6],1
						CMP		BYTE PTR [EBP+20],0
						JE		NO_G_FLAG
						OR		BYTE PTR GS:[TEST_SEG+6],80H
NO_G_FLAG:
...
NO_P_FLAG:
						...
						AND		AH,1FH
						OR		AL,AH
						MOV		GS:[TEST_SEG+5],AL


						MOV		BYTE PTR GS:[TEST_SEG+7],11H
						MOV		BYTE PTR GS:[TEST_SEG+4],22H
						MOV		WORD PTR GS:[TEST_SEG+2],3344H
