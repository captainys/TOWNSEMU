...
std::map <unsigned int,std::string> FMTownsIOMap(void)
{
	...
	ioMap[TOWNSIO_TIMER0_COUNT_LOW]="TIMER0_COUNT_LOW";
	ioMap[TOWNSIO_TIMER0_COUNT_HIGH]="TIMER0_COUNT_HIGH";
	ioMap[TOWNSIO_TIMER1_COUNT_LOW]="TIMER1_COUNT_LOW";
	ioMap[TOWNSIO_TIMER1_COUNT_HIGH]="TIMER1_COUNT_HIGH";
	ioMap[TOWNSIO_TIMER2_COUNT_LOW]="TIMER2_COUNT_LOW";
	ioMap[TOWNSIO_TIMER2_COUNT_HIGH]="TIMER2_COUNT_HIGH";
	ioMap[TOWNSIO_TIMER_0_1_2_CTRL]="TIMER_0_1_2_CTRL";
	ioMap[TOWNSIO_TIMER3_COUNT_LOW]="TIMER3_COUNT_LOW";
	ioMap[TOWNSIO_TIMER3_COUNT_HIGH]="TIMER3_COUNT_HIGH";
	ioMap[TOWNSIO_TIMER4_COUNT_LOW]="TIMER4_COUNT_LOW";
	ioMap[TOWNSIO_TIMER4_COUNT_HIGH]="TIMER4_COUNT_HIGH";
	ioMap[TOWNSIO_TIMER5_COUNT_LOW]="TIMER5_COUNT_LOW";
	ioMap[TOWNSIO_TIMER5_COUNT_HIGH]="TIMER5_COUNT_HIGH";
