...
enum
{
	...
	TOWNS_KEYFLAG_THUMBSHIFT_SHIFT=           0x04,
	TOWNS_KEYFLAG_THUMBSHIFT_CTRL=            0x08,
	TOWNS_KEYFLAG_THUMBSHIFT_PRESS_OR_RELEASE=0x10,
	TOWNS_KEYFLAG_THUMBSHIFT_TYPE_THUMBSHIFT= 0x00,
	TOWNS_KEYFLAG_THUMBSHIFT_TYPE_JIS=        0x20,
	TOWNS_KEYFLAG_THUMBSHIFT_TYPE_NEWJIS=     0x40,
	TOWNS_KEYFLAG_THUMBSHIFT_TYPE_UNDEFINED=  0x60,
	TOWNS_KEYFLAG_THUMBSHIFT_TYPE_FIRSTBYTE=  0x80,
};

#define TOWNS_KEYFLAG_JIS_PRESS (TOWNS_KEYFLAG_THUMBSHIFT_TYPE_FIRSTBYTE|TOWNS_KEYFLAG_THUMBSHIFT_TYPE_JIS|TOWNS_KEYFLAG_THUMBSHIFT_PRESS_OR_RELEASE)
#define TOWNS_KEYFLAG_JIS_RELEASE (TOWNS_KEYFLAG_THUMBSHIFT_TYPE_FIRSTBYTE|TOWNS_KEYFLAG_THUMBSHIFT_TYPE_JIS)
